 ...
 * 
 * ```php
 * $configProvider = new YiiAppConfigProvider(['globalConfig' => $globalConfig]);
 ...
 */
class YiiAppConfigProvider extends \yii\base\Object implements \pyd\testkit\interfaces\InterfaceYiiAppConfigProvider
{
    /**
